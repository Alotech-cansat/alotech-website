    ...
    <main className={styles.main}>
      ...
      <section className={styles.us} id ="about-us">
        ...
        <div className={styles.us_images}>
          ...
          <Member member = {`${prefix}/kajtek.jpg`} member_hobby = {`${prefix}/kajtek-hobby.jpg`} name = "Kajetan Kwiecień" role = "Data Analyst  / Physics Expert"></Member>
          <Member member = {`${prefix}/logo.png`} member_hobby = {`${prefix}/logo.png`} name = "Grzegorz Diaconescu" role = "Electrical Engineer"></Member>
        </div>
      </section>
